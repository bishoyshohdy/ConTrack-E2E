  ...
  return (
    ...
    >
      ...
      <Box>
        <Heading
          as={"span"}
          fontSize={useScreenSize().size >= SCREEN_SIZE.MD ? "3xl" : "xl"}
          color={"secondary.100"}
          mt={5}
          mb={2}
        >
          ...
          (navData[1].toLowerCase().includes("cylock") ||
            ...
            <IconButton
              ...
              isRound={true}
              bg={"transparent"}
              _hover={{ textDecor: "none", backgroundColor: "secondary.10" }}
              icon={<ArrowBackIcon />}
              onClick={() => {
                const Tab = navData[1].toLowerCase() === "cytag" ? 2 : 1;
          ...
          {navData[0].length > 0 &&
            navData[navData.length - 1].split("-").map((navD) => {
            ...
            <DrawerContent bg={"primary.80"}>
              ...
              <DrawerHeader>
                <Flex>
                  <Logo
                    w={100}
                    logo={themeCtx.darkMode ? lightLogo : DarkLogo}
                  />
                </Flex>
              </DrawerHeader>
              <DrawerBody>
