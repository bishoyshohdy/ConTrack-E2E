...
function Users() {
  ...
  const createNewUser = () => {
    createUser(
      ...
      userDevices.map((device) => device.value)
    ).then((res) => {
  ...
  return (
    <>
      <Flex p={2} flexWrap={"wrap"} gap={2}>
        <Box w={"100%"} justifyContent={"start"} mx={4} mt={2} as={Flex}>
                ...
                <Box w={"100%"} gap={5} as={Flex} alignItems={"center"}>
                  ...
                  <Box w={"100%"}>
                    <StyledSelect
                      ...
                      options={currentUserDevices.map((device) => {
            ...
            {users.map((user) => {
              ...
              return (
                <AvatarCard
                  ...
                  subtitle={user.name}
                  role={
                    user.super_role ? user.super_role.name : "No role assigned"
                  }
                  deviceGroup={
                    user.device_group
